              ...
              title: Row(
                children: [
                  Image.asset('assets/images/tigo_pesa.png', width: 24, height: 24,
                    errorBuilder: (context, error, stackTrace) => const Icon(Icons.phone_android, color: Colors.teal),
                  ),
                  const SizedBox(width: 10),
                  const Text('Tigo Pesa'),
                ],
              ),
              value: 'Tigo Pesa',
            ...
            Row(
              children: [
                Image.asset('assets/images/tigo_pesa.png', width: 30, height: 30,
                  errorBuilder: (context, error, stackTrace) => const Icon(Icons.phone_android, color: Colors.teal, size: 30),
                ),
                const SizedBox(width: 10),
                const Text(
                  'Tigo Pesa Details',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 5),
                  const Text('1. Dial *150*01#'),
                  const Text('2. Select 4 - Pay Bills'),
                  const Text('3. Select 4 - Enter Business Number'),
                  const Text('4. Enter 123456'),
                  Text('5. Enter amount ${widget.orderDetails?['totalAmount'] ?? "0"}'),
                  const Text('6. Enter PIN to confirm'),
                ],
              ),
            ),
          ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  const Text('How to pay:', style: TextStyle(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 5),
                  const Text('1. Dial *150*00#'),
                  const Text('2. Select 4 - Pay By M-Pesa'),
                  const Text('3. Select 4 - Enter Business Number'),
                  const Text('4. Enter 123456'),
                  Text('5. Enter amount ${widget.orderDetails?['totalAmount'] ?? "0"}'),
                  const Text('6. Enter PIN to confirm'),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 5),
                  const Text('• Payment will be collected upon delivery'),
                  Text('• Please have the exact amount ready: ${widget.orderDetails?['totalAmount'] ?? "0"} TZS'),
                  const Text('• Delivery time: Within 24-48 hours'),
                  const Text('• You will receive a call before delivery'),
                ],
              ),
            ),
          ],
